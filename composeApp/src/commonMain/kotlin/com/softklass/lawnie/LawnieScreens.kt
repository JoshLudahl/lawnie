...
fun SettingsScreen(modifier: Modifier = Modifier) {
    ...
    // For launching Auth0 hosted login page
    val uriHandler = androidx.compose.ui.platform.LocalUriHandler.current
    val authUrl = auth0AuthorizeUrl()
    ...
    Column(
        ...
        // Auth0 Sign-In section
        HorizontalDivider(modifier = Modifier.padding(top = 16.dp))
        Text(text = "Account", style = MaterialTheme.typography.titleMedium, modifier = Modifier.padding(top = 16.dp))
        Text(text = "Sign in to sync your settings across devices.", style = MaterialTheme.typography.bodySmall, modifier = Modifier.padding(top = 8.dp))
        Button(onClick = { uriHandler.openUri(authUrl) }, modifier = Modifier.padding(top = 8.dp)) {
            Text("Sign in with Auth0")
        }
        Text(
            text = "Uses Auth0 hosted login. Update domain, clientId, redirectUri in Auth0Config.",
